...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 11300 }, { marker: 'pandoc', elapsed: 260 }, { marker: 'post-processor', elapsed: 80 }, { marker: 'pre-processor', elapsed: 20 }, { marker: 'render', elapsed: 12480 } ];
