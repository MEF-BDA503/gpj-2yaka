...
Our EDA is in good compliance with the results deduced from K-Means clustering. We are able to match our previously found groups with three clusters. Furthermore Decision Tree Analysis supports our findings. As a conlusion, we find that the satisfaction level is the key factor to quit the job. 
